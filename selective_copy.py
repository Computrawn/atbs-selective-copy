...
def find_files(directory: Path) -> list[str]:
    """Walk through directory tree and create list of files matching
    user-defined extension, then notify user of match results."""
...
def main() -> None:
    """Validate directory, search folders for extensions and copy
    matching files to designated folder."""
    try:
